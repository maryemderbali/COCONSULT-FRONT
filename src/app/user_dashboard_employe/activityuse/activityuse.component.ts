...
import { AddactivityComponent } from 'src/app/admin/addactivity/addactivity.component';
import { EditActivityComponent } from 'src/app/edit-activity/edit-activity.component';
@Component({
  selector: 'app-activityuse',
  templateUrl: './activityuse.component.html',
  styleUrls: ['./activityuse.component.css']
})
export class ActivityuseComponent implements OnInit, OnDestroy {
  activities: Activity[] = [];
