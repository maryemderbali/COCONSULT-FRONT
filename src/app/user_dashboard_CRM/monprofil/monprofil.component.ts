...
import { PayementService } from 'src/app/_services/payement.service';
...
export class MonprofilComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.payementService.getDailySales().subscribe(data => {
            const labels = Object.keys(data); // Extract labels
            const series = [Object.values(data)]; // Extract series data
