...
exports.ROUTES = [
    { path: '/user_dashboard_CRM/monprofil', title: 'mon-profile', icon: 'person', "class": '' },
    { path: '/user_dashboard_CRM/solutions', title: 'solutions', icon: 'dashboard', "class": '' },
    { path: '/user_dashboard_CRM/settings', title: 'settings&Infos', icon: 'settingsOutline', "class": '' },
];
